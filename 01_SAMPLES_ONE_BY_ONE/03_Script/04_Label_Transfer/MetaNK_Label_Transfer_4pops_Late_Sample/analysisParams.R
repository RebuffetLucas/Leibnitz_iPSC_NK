...
SUB_ANALYSIS_STEP_NAME= "MetaNK_Label_Transfer_4pops_Late_Sample"
...
LITERAL_TITLE = "Projecting Meta-NK classification in the Late Sample of iPSC derived NK cells"
...
#Query Dataset
PATH_QUERY_RDS = file.path(PATH_EXPERIMENT_OUTPUT, "02_Azimuth_Mapping","List_Seurat_Objects_Post_02_Azimuth.rds")

#Sample to extract from a list of Seurat Object
DO_EXTRACT_FROM_A_SEURAT_LIST = TRUE
NAME_SEURAT_OBJECT_TO_EXTRACT = "Raw_NK4937_After_Expansion"

#Analysis params
# Work on a subset
SUBSET_DOWNSAMPLE= FALSE
N_DOWNSAMPLE = 50000

#Work on a subset based on a variable
DO_SUBSET_VARIABLE = TRUE
VARIABLE_TO_SUBSET = "seurat_clusters"
CATEGORIES_TO_SUBSET = c("0", "1","2","3","4","5") # Remove only the dying cells
...
TRESHOLD_NEW_ID_REMOVING = 50 # Minimal number of cells identified to keep the cluster


NUMBER_GENES_FOR_SCORING = 30
...
#Save RDS file?
SAVE_RDS = TRUE
RDS_DIR_OUTPUT = file.path( PATH_ANALYSIS_OUTPUT ,  paste0("Post_Label_Transfer_Harmo_", NAME_SEURAT_OBJECT_TO_EXTRACT,"_alldata.rds"))
