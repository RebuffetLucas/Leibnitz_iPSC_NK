...
GLOBAL_DESCRIPTION = "Analysis of NK cells products derived from a new cell product manufacturing protocol"
...
# Example : "moFluMemB"
SCIENTIFIC_PROJECT_NAME = "Leibniz_iPSC_NK"
...
EXPERIMENT_NAME = "01_SAMPLES_ONE_BY_ONE"
...
#Path to data
PATH_CELLRANGER_FILES = file.path( PATH_EXPERIMENT_RAWDATA, "Cell_Ranger_Outputs")
#PATH_h5ad_FILES = file.path( PATH_EXPERIMENT_RAWDATA, "h5ad_Files" ) 
#PATH_h5ad_FILES_NoMetadata = file.path( PATH_EXPERIMENT_RAWDATA, "h5ad_Files_Metadata_Separated" ) 
